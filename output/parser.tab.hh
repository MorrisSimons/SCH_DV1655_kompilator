...
#ifndef YY_YY_OUTPUT_PARSER_TAB_HH_INCLUDED
# define YY_YY_OUTPUT_PARSER_TAB_HH_INCLUDED
  ...
  private:
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_MainClassMethod = 47,                  // MainClassMethod
        S_MainClassBody = 48,                    // MainClassBody
        ...
        S_BlockContent = 53,                     // BlockContent
        S_TypeIdentifier = 54,                   // TypeIdentifier
        S_TypeIdentifierList = 55,               // TypeIdentifierList
        S_VarType = 56,                          // VarType
        S_VarDeclaration = 57,                   // VarDeclaration
        S_VarDeclarationList = 58,               // VarDeclarationList
        S_VariableAndStatement = 59,             // VariableAndStatement
        S_VariablesAndStatementList = 60,        // VariablesAndStatementList
        S_Statement = 61,                        // Statement
        S_StatementList = 62,                    // StatementList
        S_StatementsNonEmpty = 63,               // StatementsNonEmpty
        S_Expression = 64,                       // Expression
        S_OrExpression = 65,                     // OrExpression
        S_AndExpression = 66,                    // AndExpression
        S_EqualExpression = 67,                  // EqualExpression
        S_CompareExpression = 68,                // CompareExpression
        S_AddSubExpression = 69,                 // AddSubExpression
        S_MulDivExpression = 70,                 // MulDivExpression
        S_NotExpression = 71,                    // NotExpression
        S_BaseExpression = 72,                   // BaseExpression
        S_ExpressionList = 73,                   // ExpressionList
        S_ExpressionsNonEmpty = 74,              // ExpressionsNonEmpty
...
switch (yykind)
    ...
    // Implementation of make_symbol for each token kind.
      ...
      static
      symbol_type
      make_INT_LITERAL (const std::string& v)
      {
...
#line 2351 "./output/parser.tab.hh"




#endif // !YY_YY_OUTPUT_PARSER_TAB_HH_INCLUDED
